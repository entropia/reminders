...
SUBJECT = "Erinnerung: morgen Lockpicking-Treffen"
MESSAGE_TMPL = """\
Liebe Entropianer,

wie an jedem vierten Mittwoch im Monat ist morgen
ab %(begin)s ein Lockpicking-Treffen des SSD e.V.

Neugierige sind dabei herzlich willkommen. Jedoch benötigen
die Lockpicker den Hauptraumtisch, etwas Ruhe und gutes Licht.

Das bedeutet, dass ihr morgen keine anderen Treffen
im Club planen solltet.
